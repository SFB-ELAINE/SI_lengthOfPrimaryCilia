# Script for working with CiliaQ results                           +++++++++
...
# input_dir <- "CiliaQ/"
input_dir <- "CiliaQ/testImages/2D/"

# Output directory
# output_dir <- "CiliaQ/output/"
output_dir <- "CiliaQ/testImages/2D/output/"
...
write.csv(x = df_data,
          file = paste(output_dir, "ciliaq_data.csv", sep=""),
          row.names = FALSE)
write.csv2(x = df_data,
           file = paste(output_dir, "ciliaq_data_de.csv", sep=""),
           row.names = FALSE)
